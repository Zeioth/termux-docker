...
* **Do I need to run the docker images every time?** No. You can see we are using "--restart=unless-stopped" which means the images will run automatically every time you run "startqemu.sh".
